...
#define  OLED_W_SCL(x)  ((x)?(DL_GPIO_setPins(GPIOB,DL_GPIO_PIN_9)) : (DL_GPIO_clearPins(GPIOB,DL_GPIO_PIN_9)) )
#define  OLED_W_SDA(x)  ((x)?(DL_GPIO_setPins(GPIOB,DL_GPIO_PIN_8)) : (DL_GPIO_clearPins(GPIOB,DL_GPIO_PIN_8)) )
#endif
