...
/*************************** 硬件抽象层配置 ****************************/
// GPIO地址切换宏定义
#define Switch_Address_0(i) ((i)?(DL_GPIO_setPins(Gray_Addr_PORT,Gray_Addr_AD0_PIN)) : (DL_GPIO_clearPins(Gray_Addr_PORT,Gray_Addr_AD0_PIN)))// 地址位0控制

#define Switch_Address_1(i) ((i)?(DL_GPIO_setPins(Gray_Addr_PORT,Gray_Addr_AD1_PIN)) : (DL_GPIO_clearPins(Gray_Addr_PORT,Gray_Addr_AD1_PIN)))// 地址位1控制

#define Switch_Address_2(i) ((i)?(DL_GPIO_setPins(Gray_Addr_PORT,Gray_Addr_AD2_PIN)) : (DL_GPIO_clearPins(Gray_Addr_PORT,Gray_Addr_AD2_PIN)))// 地址位2控制
