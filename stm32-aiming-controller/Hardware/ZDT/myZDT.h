...
#define MOTOR_X_UART        UART4        // X轴电机串口 xia
#define MOTOR_Y_UART        UART5        // Y轴电机串口 shang
...
extern volatile int32_t Motor_Pulse_Count;
...
void Trigger_Return(uint8_t addr);
void Emm_Read_Pulse(uint8_t addr);
