...
//自定义代码
int inv_imu_get_raw_data(inv_imu_device_t *s, inv_imu_sensor_rawdata_t *data)
{
	int status = INV_IMU_OK;

	status |= inv_imu_read_reg(s, ACCEL_DATA_X1_UI, sizeof(inv_imu_sensor_rawdata_t), (uint8_t *)data);
