...
/*************************** 硬件抽象层配置 ****************************/
// GPIO地址切换宏定义
#define Switch_Address_0(i) ((i)?(GPIO_WriteBit(GPIOC, GPIO_Pin_0,Bit_SET)) : (GPIO_WriteBit(GPIOC, GPIO_Pin_0,Bit_RESET)))// 地址位0控制

#define Switch_Address_1(i) ((i)?(GPIO_WriteBit(GPIOC, GPIO_Pin_1,Bit_SET)) : (GPIO_WriteBit(GPIOC, GPIO_Pin_1,Bit_RESET)))// 地址位1控制

#define Switch_Address_2(i) ((i)?(GPIO_WriteBit(GPIOC, GPIO_Pin_2,Bit_SET)) : (GPIO_WriteBit(GPIOC, GPIO_Pin_2,Bit_RESET)))// 地址位2控制
